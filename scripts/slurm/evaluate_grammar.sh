...
#SBATCH --output=logs/eval_grammar_%j.out
#SBATCH --error=logs/eval_grammar_%j.err
...
# Usage: sbatch evaluate_grammar.sh <model_name> <test_data> <output_path>
# Example: sbatch evaluate_grammar.sh gpt2-medium hpc_datasets/jfleg_test.csv results/grammar_gpt2-medium_jfleg_test.csv
...
MODEL_PATH="models/${MODEL_ID}_grammar/final_model"
